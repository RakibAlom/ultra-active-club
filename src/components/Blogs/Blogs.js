...
const Blogs = () => {
  return (
    <div>
      ...
      <div class="accordion accordion-flush" id="singleBlog">
        <div class="accordion-item rounded-3 mb-3">
          <h2 class="accordion-header" id="blog1">
            <button class="accordion-button collapsed shadow-none rounded-sm" type="button" data-bs-toggle="collapse" data-bs-target="#blogOne" aria-expanded="false" aria-controls="blogOne">
              What Is React & How Does React Works?
            </button>
          </h2>
          <div id="blogOne" class="accordion-collapse collapse" aria-labelledby="blog1" data-bs-parent="#singleBlog">
        ...
        <div class="accordion-item rounded-3 mb-3">
          <h2 class="accordion-header" id="blog2">
            <button class="accordion-button collapsed shadow-none rounded-sm" type="button" data-bs-toggle="collapse" data-bs-target="#blogTwo" aria-expanded="false" aria-controls="blogTwo">
              What is the difference between props and state?
            </button>
          </h2>
          <div id="blogTwo" class="accordion-collapse collapse" aria-labelledby="blog2" data-bs-parent="#singleBlog">
            <div class="accordion-body">
        ...
        <div class="accordion-item rounded-3 mb-3">
          <h2 class="accordion-header" id="blog3">
            <button class="accordion-button collapsed shadow-none rounded-sm" type="button" data-bs-toggle="collapse" data-bs-target="#blogThree" aria-expanded="false" aria-controls="blogThree">
              What is the use of useEffect without loading api data?
            </button>
          </h2>
          <div id="blogThree" class="accordion-collapse collapse" aria-labelledby="blog3" data-bs-parent="#singleBlog">
            <div class="accordion-body">
