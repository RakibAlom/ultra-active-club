  ...
  return (
    <div className="col-xl-4 col-lg-6 col-12 mb-4">
      <div className="single-excersie">
        <div className="card border-0 rounded-4 p-3 p-md-4 shadow-sm">
          ...
          <button onClick={() => handlerAddToList(exercise)} className="btn btn-add-list w-100 rounded-3 py-2">Add to list</button>
        </div>
      </div>
    </div>
  );
